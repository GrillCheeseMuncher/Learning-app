...
const FilterButton = ({ handleLetterSort, handleNumberSort, horizontal }: Props) => {
  ...
  return (
    <div className="pokelist-dropdown">
      ...
      <div
        className={`pokelist-dropdown-content${isClicked ? ' show' : ''}${
          isClicked && horizontal ? ' horizontal' : ''
        }`}
      >
        <button
